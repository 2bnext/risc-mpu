...
def find_port():
    ...
    # the kernel happens to assign (matters under WSL+usbipd, where the
    # iCESugar often lands on ttyACM0 instead of ttyACM1).
    for link in glob.glob('/dev/serial/by-id/usb-*DAPLink*-if01'):
